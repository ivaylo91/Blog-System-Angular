...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ['/* angular:styles/component:scss;4278189f2ba7013b029c0f0303b35dbb7a5f0d3338558d0036cc83439879547a;C:/Users/ipene/Desktop/Blog-System-Angular/frontend/src/app/pages/dashboard-comments/dashboard-comments.component.ts */\n.dashboard-comments {\n  max-width: 1100px;\n  margin: 0 auto;\n  padding: 2rem 1.5rem 3rem;\n}\n.header-row {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  margin-bottom: 1.5rem;\n  gap: 1rem;\n  flex-wrap: wrap;\n}\nh1 {\n  font-family:\n    "Playfair Display",\n    Georgia,\n    serif;\n  font-size: 1.75rem;\n  color: #1c1917;\n  margin: 0 0 0.2rem;\n  letter-spacing: -0.02em;\n}\n.subtitle {\n  color: #57534e;\n  font-size: 0.85rem;\n  margin: 0;\n}\n.btn-bulk-delete {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.4rem;\n  padding: 0.6rem 1.1rem;\n  background: #fef2f2;\n  color: #b91c1c;\n  border: 1.5px solid #fca5a5;\n  border-radius: 0.75rem;\n  font-weight: 600;\n  font-size: 0.875rem;\n  cursor: pointer;\n  transition: background 0.18s, border-color 0.18s;\n  touch-action: manipulation;\n  white-space: nowrap;\n}\n.btn-bulk-delete svg {\n  width: 0.875rem;\n  height: 0.875rem;\n  flex-shrink: 0;\n}\n.btn-bulk-delete:hover {\n  background: #fee2e2;\n  border-color: #f87171;\n  color: #991b1b;\n}\n.table-wrap {\n  background: #ffffff;\n  border-radius: 1.25rem;\n  border: 1px solid rgba(0, 0, 0, 0.09);\n  overflow-x: auto;\n  box-shadow: 0 2px 12px rgba(0, 0, 0, 0.06);\n}\n.empty-state {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 0.5rem;\n  padding: 4rem 2rem;\n  color: #a8a29e;\n  text-align: center;\n}\n.empty-state svg {\n  width: 3rem;\n  height: 3rem;\n  margin-bottom: 0.25rem;\n}\n.empty-state p {\n  font-size: 1rem;\n  font-weight: 600;\n  color: #44403c;\n  margin: 0;\n}\n.empty-state span {\n  font-size: 0.875rem;\n}\ntable {\n  width: 100%;\n  border-collapse: collapse;\n}\nth {\n  text-align: left;\n  padding: 0.7rem 1rem;\n  font-size: 0.75rem;\n  text-transform: uppercase;\n  letter-spacing: 0.06em;\n  color: #57534e;\n  font-weight: 700;\n  border-bottom: 2px solid rgba(0, 0, 0, 0.08);\n  background: #f5f0e8;\n  white-space: nowrap;\n}\n.th-check {\n  width: 2.5rem;\n  padding: 0.7rem 0.75rem;\n}\ntd {\n  padding: 0.75rem 1rem;\n  border-bottom: 1px solid rgba(0, 0, 0, 0.06);\n  font-size: 0.875rem;\n  color: #1c1917;\n  vertical-align: middle;\n}\n.td-check {\n  padding: 0.75rem 0.75rem;\n}\ntbody tr {\n  transition: background 0.15s;\n}\ntbody tr:hover {\n  background: #faf7f4;\n}\ntbody tr.selected-row {\n  background: #fef9f0;\n}\ntbody tr:last-child td {\n  border-bottom: none;\n}\n.author-cell {\n  white-space: nowrap;\n}\n.author-wrap {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.author-avatar {\n  width: 1.75rem;\n  height: 1.75rem;\n  border-radius: 50%;\n  background: #4a7c59;\n  color: #fff;\n  font-size: 0.68rem;\n  font-weight: 700;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-shrink: 0;\n  text-transform: uppercase;\n}\n.author-wrap span {\n  font-weight: 600;\n  font-size: 0.85rem;\n  color: #1c1917;\n}\n.recipe-cell {\n  max-width: 160px;\n}\n.recipe-link {\n  color: #78350f;\n  text-decoration: none;\n  font-weight: 600;\n  font-size: 0.83rem;\n  display: -webkit-box;\n  -webkit-line-clamp: 1;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n}\n.recipe-link:hover {\n  text-decoration: underline;\n}\n.content-cell {\n  max-width: 280px;\n  color: #44403c;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  line-height: 1.5;\n  white-space: normal;\n}\n.rating-badge {\n  display: inline-block;\n  padding: 0.15rem 0.5rem;\n  background: #fef3c7;\n  color: #92400e;\n  border-radius: 999px;\n  font-size: 0.75rem;\n  font-weight: 700;\n}\n.no-val {\n  color: #c4b49a;\n}\n.date-cell {\n  white-space: nowrap;\n  color: #78716c;\n  font-size: 0.82rem;\n}\n.actions-cell {\n  white-space: nowrap;\n}\n.btn-delete {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n  padding: 0.35rem 0.65rem;\n  border-radius: 0.5rem;\n  font-size: 0.78rem;\n  font-weight: 600;\n  cursor: pointer;\n  border: 1.5px solid #fca5a5;\n  background: #fff;\n  color: #b91c1c;\n  transition: background 0.18s, border-color 0.18s;\n  touch-action: manipulation;\n}\n.btn-delete svg {\n  width: 0.8rem;\n  height: 0.8rem;\n  flex-shrink: 0;\n}\n.btn-delete:hover {\n  background: #fef2f2;\n  border-color: #f87171;\n  color: #991b1b;\n}\ninput[type=checkbox] {\n  width: 1rem;\n  height: 1rem;\n  cursor: pointer;\n  accent-color: #78350f;\n}\n@media (max-width: 768px) {\n  .dashboard-comments {\n    padding: 1.5rem 1rem 2.5rem;\n  }\n  .header-row {\n    flex-direction: column;\n    align-items: stretch;\n  }\n}\n/*# sourceMappingURL=dashboard-comments.component.css.map */\n'] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardCommentsComponent, { className: "DashboardCommentsComponent", filePath: "src/app/pages/dashboard-comments/dashboard-comments.component.ts", lineNumber: 288 });
})();
export {
  DashboardCommentsComponent
};
//# sourceMappingURL=chunk-7XNGVO6N.js.map
