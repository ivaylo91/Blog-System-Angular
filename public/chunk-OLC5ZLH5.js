...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;07d39493c1634b1b6443bfe6c3095ee986b0413ab389ef0d0a820574667a7241;/home/ivaylo-penev/Desktop/Blog-System-Angular/frontend/src/app/pages/dashboard-recipe-edit/dashboard-recipe-edit.component.ts */\n.edit-page {\n  max-width: 1100px;\n  margin: 0 auto;\n  padding: 2rem 1.5rem 4rem;\n}\n.page-header {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 1rem;\n  margin-bottom: 1.75rem;\n}\n.breadcrumb {\n  font-size: 0.8rem;\n  color: var(--clr-text-muted);\n  margin: 0 0 var(--space-1);\n  display: flex;\n  align-items: center;\n  gap: var(--space-2);\n}\n.breadcrumb a {\n  color: var(--clr-green);\n  text-decoration: none;\n  font-weight: 500;\n}\n.breadcrumb a:hover {\n  text-decoration: underline;\n}\nh1 {\n  font-family: var(--font-display);\n  font-size: clamp(1.6rem, 3vw, 1.9rem);\n  font-weight: 800;\n  color: var(--clr-text);\n  margin: 0;\n  letter-spacing: -0.025em;\n}\n.header-actions {\n  display: flex;\n  gap: var(--space-3);\n  align-items: center;\n  flex-shrink: 0;\n}\n.error-box {\n  display: flex;\n  align-items: center;\n  gap: var(--space-3);\n  padding: var(--space-3) var(--space-4);\n  background: var(--clr-error-bg);\n  border: 1px solid color-mix(in oklch, var(--clr-error) 40%, transparent);\n  border-radius: var(--radius-md);\n  color: var(--clr-error);\n  font-size: 0.875rem;\n  font-weight: 500;\n  margin-bottom: var(--space-6);\n}\n.error-box svg {\n  width: 1.1rem;\n  height: 1.1rem;\n  flex-shrink: 0;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: 1fr 320px;\n  gap: var(--space-6);\n  align-items: start;\n}\n.col-main,\n.col-side {\n  display: flex;\n  flex-direction: column;\n  gap: var(--space-6);\n}\n.card {\n  background: var(--clr-surface);\n  border-radius: var(--radius-lg);\n  border: 1px solid var(--clr-border-faint);\n  padding: var(--space-6);\n  box-shadow: var(--shadow-sm);\n}\n.card-title {\n  display: flex;\n  align-items: center;\n  gap: var(--space-2);\n  font-size: 0.78rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.1em;\n  color: var(--clr-green);\n  margin-bottom: var(--space-5);\n}\n.card-title svg {\n  width: 1rem;\n  height: 1rem;\n  flex-shrink: 0;\n}\n.field {\n  margin-bottom: var(--space-4);\n}\n.field:last-child {\n  margin-bottom: 0;\n}\n.field-row {\n  display: flex;\n  gap: var(--space-4);\n}\n.field-row .field {\n  flex: 1;\n}\nlabel {\n  display: flex;\n  align-items: center;\n  gap: var(--space-1);\n  font-size: 0.78rem;\n  font-weight: 700;\n  color: var(--clr-text-muted);\n  margin-bottom: var(--space-2);\n}\n.label-icon {\n  width: 0.85rem;\n  height: 0.85rem;\n  color: var(--clr-text-muted);\n}\n.req {\n  color: var(--clr-error);\n}\ninput,\nselect,\ntextarea {\n  width: 100%;\n  padding: var(--space-3) var(--space-4);\n  border: 1.5px solid var(--clr-border);\n  border-radius: var(--radius-sm);\n  font-size: 0.9rem;\n  font-family: inherit;\n  box-sizing: border-box;\n  background: var(--clr-surface-alt);\n  color: var(--clr-text);\n  transition:\n    border-color 0.2s var(--ease-out-expo),\n    box-shadow 0.2s var(--ease-out-expo),\n    background 0.2s var(--ease-out-expo);\n}\ninput:focus,\nselect:focus,\ntextarea:focus {\n  outline: none;\n  border-color: var(--clr-green);\n  box-shadow: 0 0 0 3px color-mix(in oklch, var(--clr-green) 12%, transparent);\n  background: var(--clr-surface);\n}\ntextarea {\n  resize: vertical;\n}\n.field-hint {\n  font-size: 0.75rem;\n  color: var(--clr-text-muted);\n  margin: var(--space-1) 0 0;\n}\n.ingredient-row {\n  display: flex;\n  align-items: center;\n  gap: var(--space-2);\n  margin-bottom: var(--space-3);\n}\n.row-index {\n  font-size: 0.75rem;\n  font-weight: 700;\n  color: var(--clr-text-muted);\n  min-width: 1.2rem;\n  text-align: right;\n}\n.qty-input {\n  flex: 0 0 110px;\n}\n.name-input {\n  flex: 1;\n}\n.step-row {\n  display: flex;\n  gap: var(--space-3);\n  align-items: flex-start;\n  margin-bottom: var(--space-3);\n}\n.step-badge {\n  flex-shrink: 0;\n  width: 1.75rem;\n  height: 1.75rem;\n  border-radius: var(--radius-circle);\n  background: var(--clr-green);\n  color: #ffffff;\n  font-size: 0.75rem;\n  font-weight: 700;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-top: 0.65rem;\n}\n.step-row textarea {\n  flex: 1;\n}\n.btn-add {\n  display: inline-flex;\n  align-items: center;\n  gap: var(--space-2);\n  padding: var(--space-3) var(--space-4);\n  border: 1.5px dashed color-mix(in oklch, var(--clr-green) 45%, transparent);\n  border-radius: var(--radius-sm);\n  background: color-mix(in oklch, var(--clr-green) 5%, transparent);\n  color: var(--clr-green);\n  font-size: 0.82rem;\n  font-weight: 600;\n  cursor: pointer;\n  width: 100%;\n  justify-content: center;\n  margin-top: var(--space-1);\n  transition: background 0.18s, border-color 0.18s;\n  touch-action: manipulation;\n  min-height: 2.5rem;\n}\n.btn-add svg {\n  width: 0.9rem;\n  height: 0.9rem;\n}\n.btn-add:hover {\n  background: color-mix(in oklch, var(--clr-green) 10%, transparent);\n  border-color: var(--clr-green);\n}\n.btn-remove {\n  flex-shrink: 0;\n  width: 2rem;\n  height: 2rem;\n  border: none;\n  background: var(--clr-error-bg);\n  color: var(--clr-error);\n  border-radius: var(--radius-xs);\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  transition: background 0.18s;\n  touch-action: manipulation;\n}\n.btn-remove svg {\n  width: 0.85rem;\n  height: 0.85rem;\n}\n.btn-remove:hover {\n  background: color-mix(in oklch, var(--clr-error-bg) 60%, var(--clr-error));\n}\n.file-drop {\n  display: block;\n  cursor: pointer;\n  border: 2px dashed var(--clr-border);\n  border-radius: var(--radius-lg);\n  overflow: hidden;\n  transition: border-color 0.2s;\n}\n.file-drop:hover {\n  border-color: var(--clr-green);\n}\n.file-drop input {\n  display: none;\n}\n.file-placeholder {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: var(--space-2);\n  padding: var(--space-8);\n  color: var(--clr-text-muted);\n}\n.file-placeholder svg {\n  width: 2rem;\n  height: 2rem;\n}\n.file-placeholder span {\n  font-size: 0.875rem;\n  font-weight: 500;\n  color: var(--clr-text-muted);\n}\n.file-placeholder small {\n  font-size: 0.75rem;\n}\n.img-preview {\n  width: 100%;\n  aspect-ratio: 16/9;\n  object-fit: cover;\n  display: block;\n}\n.btn-cancel {\n  display: inline-flex;\n  align-items: center;\n  gap: var(--space-2);\n  padding: var(--space-3) var(--space-5);\n  border-radius: var(--radius-sm);\n  text-decoration: none;\n  color: var(--clr-text-muted);\n  background: var(--clr-surface-hover);\n  border: 1.5px solid var(--clr-border);\n  font-weight: 600;\n  font-size: 0.875rem;\n  transition: background 0.18s, border-color 0.18s;\n  touch-action: manipulation;\n}\n.btn-cancel svg {\n  width: 0.875rem;\n  height: 0.875rem;\n}\n.btn-cancel:hover {\n  background: var(--clr-surface-alt);\n  border-color: var(--clr-border-strong);\n}\n.btn-save {\n  display: inline-flex;\n  align-items: center;\n  gap: var(--space-2);\n  padding: var(--space-3) var(--space-6);\n  background: var(--clr-green);\n  color: #ffffff;\n  border: none;\n  border-radius: var(--radius-pill);\n  font-weight: 700;\n  font-size: 0.875rem;\n  cursor: pointer;\n  transition: background 0.18s var(--ease-out-expo), transform 0.15s var(--ease-out-expo);\n  touch-action: manipulation;\n}\n.btn-save svg {\n  width: 0.875rem;\n  height: 0.875rem;\n}\n.btn-save:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.btn-save:hover:not(:disabled) {\n  background: var(--clr-green-dark);\n  transform: translateY(-1px);\n}\n.btn-save:active:not(:disabled) {\n  transform: translateY(0);\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n.spin {\n  animation: spin 1s linear infinite;\n}\n.toggle-row {\n  display: flex;\n  align-items: center;\n  gap: var(--space-3);\n  cursor: pointer;\n  margin-bottom: var(--space-2);\n}\n.toggle-row input[type=checkbox] {\n  width: 1.1rem;\n  height: 1.1rem;\n  flex-shrink: 0;\n  accent-color: var(--clr-green);\n}\n.toggle-label {\n  font-size: 0.9rem;\n  font-weight: 600;\n  color: var(--clr-text);\n}\n@media (max-width: 900px) {\n  .form-grid {\n    grid-template-columns: 1fr;\n  }\n  .col-side {\n    order: -1;\n  }\n}\n@media (max-width: 640px) {\n  .edit-page {\n    padding: 1.5rem 1rem 3rem;\n  }\n  .page-header {\n    flex-direction: column;\n    align-items: stretch;\n  }\n  .header-actions {\n    justify-content: flex-end;\n  }\n  .field-row {\n    flex-direction: column;\n    gap: 0;\n  }\n}\n/*# sourceMappingURL=dashboard-recipe-edit.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardRecipeEditComponent, { className: "DashboardRecipeEditComponent", filePath: "src/app/pages/dashboard-recipe-edit/dashboard-recipe-edit.component.ts", lineNumber: 517 });
})();
export {
  DashboardRecipeEditComponent
};
//# sourceMappingURL=chunk-OLC5ZLH5.js.map
