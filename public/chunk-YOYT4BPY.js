...
function RecipesComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "\u0412\u0441\u0438\u0447\u043A\u0438");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, RecipesComponent_Conditional_17_For_4_Template, 2, 4, "button", 19, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function RecipesComponent_Conditional_34_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275elementStart(5, "svg", 28);
    \u0275\u0275element(6, "line", 29)(7, "line", 30);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function RecipesComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "\u0424\u0438\u043B\u0442\u0440\u0438:");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, RecipesComponent_Conditional_34_Conditional_3_Template, 8, 1, "button", 21);
    \u0275\u0275conditionalCreate(4, RecipesComponent_Conditional_34_Conditional_4_Template, 5, 1, "button", 22);
    \u0275\u0275conditionalCreate(5, RecipesComponent_Conditional_34_Conditional_5_Template, 5, 1, "button", 23);
    \u0275\u0275conditionalCreate(6, RecipesComponent_Conditional_34_Conditional_6_Template, 5, 1, "button", 24);
...
function RecipesComponent_Conditional_35_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "div", 37)(4, "div", 38)(5, "div", 39);
    \u0275\u0275elementStart(6, "div", 40);
    \u0275\u0275element(7, "div", 41)(8, "div", 41)(9, "div", 41);
    \u0275\u0275elementEnd()()();
  }
}
function RecipesComponent_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, RecipesComponent_Conditional_35_For_2_Template, 10, 0, "div", 34, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function RecipesComponent_Conditional_36_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-recipe-card", 42);
  }
  if (rf & 2) {
...
function RecipesComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275repeaterCreate(1, RecipesComponent_Conditional_36_For_2_Template, 1, 3, "app-recipe-card", 42, _forTrack0, false, RecipesComponent_Conditional_36_ForEmpty_3_Template, 9, 0, "div", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function RecipesComponent_Conditional_37_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, RecipesComponent_Conditional_37_For_6_Conditional_0_Template, 2, 0, "span", 51)(1, RecipesComponent_Conditional_37_For_6_Conditional_1_Template, 2, 4, "button", 52);
  }
  if (rf & 2) {
...
var RecipesComponent = class _RecipesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RecipesComponent, selectors: [["app-recipes"]], decls: 38, vars: 26, consts: [[1, "page"], [1, "page-inner"], [1, "page-header"], [1, "page-eyebrow"], [1, "search-bar", 3, "submit"], ["type", "text", "name", "q", "placeholder", "\u0422\u044A\u0440\u0441\u0438 \u043F\u043E \u0437\u0430\u0433\u043B\u0430\u0432\u0438\u0435 \u0438\u043B\u0438 \u0441\u044A\u0441\u0442\u0430\u0432\u043A\u0430...", "aria-label", "\u0422\u044A\u0440\u0441\u0438 \u0440\u0435\u0446\u0435\u043F\u0442\u0438", 1, "search-input", 3, "ngModelChange", "input", "ngModel"], ["type", "submit", 1, "search-btn"], ["viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "stroke-linecap", "round", "stroke-linejoin", "round"], ["cx", "11", "cy", "11", "r", "8"], ["x1", "21", "y1", "21", "x2", "16.65", "y2", "16.65"], [1, "btn-text"], ["role", "group", "aria-label", "\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438", 1, "pill-filters"], ["role", "group", "aria-label", "\u0424\u0438\u043B\u0442\u0440\u0438", 1, "pill-filters", "pill-filters-secondary"], [1, "pill", "pill-sm", 3, "click"], ["aria-hidden", "true", 1, "sort-divider"], ["aria-label", "\u0410\u043A\u0442\u0438\u0432\u043D\u0438 \u0444\u0438\u043B\u0442\u0440\u0438", 1, "active-filters"], [1, "recipe-grid"], [1, "pagination"], [1, "pill", 3, "click"], [1, "pill", 3, "active"], [1, "filters-label"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u0442\u044A\u0440\u0441\u0435\u043D\u0435\u0442\u043E", 1, "active-chip"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F", 1, "active-chip"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u0442\u0440\u0443\u0434\u043D\u043E\u0441\u0442", 1, "active-chip"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u0441\u043E\u0440\u0442\u0438\u0440\u0430\u043D\u0435", 1, "active-chip"], [1, "clear-all", 3, "click"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u0442\u044A\u0440\u0441\u0435\u043D\u0435\u0442\u043E", 1, "active-chip", 3, "click"], ["viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "aria-hidden", "true"], ["viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.5", "aria-hidden", "true", 1, "chip-x"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F", 1, "active-chip", 3, "click"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u0442\u0440\u0443\u0434\u043D\u043E\u0441\u0442", 1, "active-chip", 3, "click"], ["aria-label", "\u041F\u0440\u0435\u043C\u0430\u0445\u043D\u0438 \u0441\u043E\u0440\u0442\u0438\u0440\u0430\u043D\u0435", 1, "active-chip", 3, "click"], [1, "skeleton-card"], [1, "sk-img"], [1, "sk-body"], [1, "sk-line", "sk-short"], [1, "sk-line", "sk-long"], [1, "sk-line", "sk-medium"], [1, "sk-meta"], [1, "sk-line", "sk-sm"], [3, "recipe", "priority", "index"], [1, "no-results"], ["viewBox", "0 0 64 64", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-hidden", "true"], ["cx", "28", "cy", "28", "r", "18"], ["x1", "41", "y1", "41", "x2", "56", "y2", "56"], ["x1", "20", "y1", "28", "x2", "36", "y2", "28"], ["aria-label", "\u041F\u0440\u0435\u0434\u0438\u0448\u043D\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430", 1, "page-btn", 3, "click", "disabled"], [1, "page-counter"], ["aria-label", "\u0421\u043B\u0435\u0434\u0432\u0430\u0449\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430", 1, "page-btn", 3, "click", "disabled"], ["aria-hidden", "true", 1, "page-ellipsis"], [1, "page-btn", 3, "active"], [1, "page-btn", 3, "click"]], template: function RecipesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(33, "\u041D\u0430\u0439-\u043B\u0435\u0441\u043D\u0438");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(34, RecipesComponent_Conditional_34_Template, 9, 4, "div", 15);
      \u0275\u0275conditionalCreate(35, RecipesComponent_Conditional_35_Template, 3, 0, "div", 16)(36, RecipesComponent_Conditional_36_Template, 4, 1, "div", 16);
      \u0275\u0275conditionalCreate(37, RecipesComponent_Conditional_37_Template, 9, 4, "div", 17);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(10);
...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ['@charset "UTF-8";\n\n/* angular:styles/component:scss;d619ca04e01ff829eeac3168cd598972e1df02285a5309a6df07ec1fac0a60f7;C:/Users/ipene/Desktop/Blog-System-Angular/frontend/src/app/pages/recipes/recipes.component.ts */\n.page {\n  padding: 3rem 1.5rem 5rem;\n  background-color: var(--clr-bg, #faf7f4);\n  background-image: url(/backgrounds/cooking-pattern.svg);\n  background-size: 500px;\n  background-repeat: repeat;\n  min-height: 100dvh;\n}\n.page-inner {\n  max-width: 1200px;\n  margin: 0 auto;\n}\n.page-header {\n  text-align: left;\n  margin-bottom: 2rem;\n}\n.page-eyebrow {\n  display: inline-flex;\n  align-items: center;\n  font-size: 0.7rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.16em;\n  color: var(--clr-green-text);\n  background: var(--clr-green-bg);\n  padding: 0.3rem 0.9rem;\n  border-radius: 9999px;\n  margin-bottom: 1rem;\n}\n.page-header h1 {\n  font-family: var(--font-display, "Alegreya", Georgia, serif);\n  font-size: clamp(2rem, 4vw, 3rem);\n  color: var(--clr-text);\n  margin: 0 0 0.5rem;\n  letter-spacing: -0.02em;\n}\n.page-header p {\n  color: var(--clr-text-muted);\n  font-size: 1rem;\n  font-weight: 300;\n  margin: 0;\n  max-width: 55ch;\n}\n.search-bar {\n  display: flex;\n  border-radius: 0.875rem;\n  overflow: hidden;\n  box-shadow: var(--shadow-sm);\n  border: 1.5px solid var(--clr-border);\n  max-width: 560px;\n  margin: 0 0 1.5rem;\n  background: var(--clr-surface);\n}\n.search-input {\n  flex: 1;\n  padding: 0.85rem 1.25rem;\n  border: none;\n  font-size: 0.95rem;\n  outline: none;\n  background: transparent;\n  color: var(--clr-text);\n}\n.search-btn {\n  display: flex;\n  align-items: center;\n  gap: 0.45rem;\n  padding: 0.85rem 1.5rem;\n  background: var(--clr-green);\n  color: var(--clr-surface);\n  border: none;\n  font-weight: 600;\n  font-size: 0.9rem;\n  cursor: pointer;\n  transition: background 0.18s var(--ease-out-expo);\n  touch-action: manipulation;\n}\n.search-btn svg {\n  width: 1rem;\n  height: 1rem;\n  flex-shrink: 0;\n}\n.search-btn:hover {\n  background: var(--clr-green-dark);\n}\n.pill-filters {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.5rem;\n  margin-bottom: 0.75rem;\n  justify-content: flex-start;\n}\n.pill-filters-secondary {\n  margin-bottom: 2.5rem;\n  align-items: center;\n  justify-content: flex-start;\n}\n.pill {\n  padding: 0.5rem 1.1rem;\n  border-radius: 9999px;\n  border: 1.5px solid var(--clr-border);\n  background: var(--clr-surface);\n  color: var(--clr-text-muted);\n  font-size: 0.875rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition:\n    background 0.18s var(--ease-out-expo),\n    border-color 0.18s var(--ease-out-expo),\n    color 0.18s var(--ease-out-expo);\n  white-space: nowrap;\n  min-height: 2.75rem;\n  touch-action: manipulation;\n}\n.pill:hover {\n  background: var(--clr-surface-hover);\n  border-color: var(--clr-border-strong);\n  color: var(--clr-text);\n}\n.pill.active {\n  background: var(--clr-brand);\n  border-color: var(--clr-brand);\n  color: var(--clr-surface);\n  font-weight: 600;\n}\n.pill:focus-visible {\n  outline: 2.5px solid var(--clr-focus);\n  outline-offset: 2px;\n}\n.pill-sm {\n  padding: 0.4rem 0.9rem;\n  font-size: 0.8rem;\n  min-height: 2.75rem;\n}\n.sort-divider {\n  width: 1px;\n  height: 1.25rem;\n  background: var(--clr-border-strong);\n  flex-shrink: 0;\n  align-self: center;\n  margin: 0 0.25rem;\n}\n.active-filters {\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n  gap: 0.5rem;\n  margin-bottom: 1.5rem;\n  padding: 0.75rem 1rem;\n  background: var(--clr-surface-alt);\n  border-radius: 0.875rem;\n  border: 1px solid var(--clr-border-faint);\n}\n.filters-label {\n  font-size: 0.72rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.08em;\n  color: var(--clr-text-faint);\n  margin-right: 0.25rem;\n  flex-shrink: 0;\n}\n.active-chip {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.3rem;\n  padding: 0.35rem 0.6rem 0.35rem 0.7rem;\n  background: var(--clr-text);\n  color: var(--clr-bg);\n  border: none;\n  border-radius: 9999px;\n  font-size: 0.78rem;\n  font-weight: 600;\n  cursor: pointer;\n  transition: background 0.15s var(--ease-out-expo), transform 0.15s var(--ease-out-expo);\n  touch-action: manipulation;\n}\n.active-chip:hover {\n  background: var(--clr-text-muted);\n}\n.active-chip:active {\n  transform: scale(0.97);\n}\n.active-chip > svg:first-child {\n  width: 0.7rem;\n  height: 0.7rem;\n  opacity: 0.7;\n}\n.chip-x {\n  width: 0.7rem;\n  height: 0.7rem;\n  opacity: 0.6;\n  flex-shrink: 0;\n}\n.clear-all {\n  margin-left: auto;\n  background: none;\n  border: none;\n  font-size: 0.75rem;\n  font-weight: 600;\n  color: var(--clr-text-muted);\n  cursor: pointer;\n  text-decoration: underline;\n  text-underline-offset: 2px;\n  padding: 0.25rem;\n  transition: color 0.15s var(--ease-out-expo);\n  touch-action: manipulation;\n}\n.clear-all:hover {\n  color: var(--clr-text);\n}\n.recipe-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));\n  gap: 1.5rem;\n}\n.no-results {\n  grid-column: 1/-1;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 0.5rem;\n  padding: 4rem 2rem;\n  color: var(--clr-text-muted);\n  text-align: center;\n}\n.no-results svg {\n  width: 3rem;\n  height: 3rem;\n  color: var(--clr-text-faint);\n  margin-bottom: 0.5rem;\n}\n.no-results p {\n  font-size: 1.05rem;\n  font-weight: 600;\n  color: var(--clr-text);\n  margin: 0;\n}\n.no-results span {\n  font-size: 0.875rem;\n  color: var(--clr-text-faint);\n}\n.skeleton-card {\n  border-radius: 1.25rem;\n  overflow: hidden;\n  background: var(--clr-surface);\n  box-shadow: var(--shadow-sm);\n}\n.sk-img {\n  aspect-ratio: 4/3;\n  background: var(--clr-skeleton);\n  position: relative;\n  overflow: hidden;\n}\n.sk-img::after {\n  content: "";\n  position: absolute;\n  inset: 0;\n  background:\n    linear-gradient(\n      90deg,\n      transparent 0%,\n      var(--clr-skeleton-shine) 50%,\n      transparent 100%);\n  transform: translateX(-100%);\n  animation: shimmer 1.5s linear infinite;\n}\n.sk-body {\n  padding: 1.2rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.55rem;\n}\n.sk-meta {\n  display: flex;\n  gap: 0.75rem;\n  margin-top: 0.25rem;\n}\n.sk-line {\n  height: 0.8rem;\n  border-radius: 9999px;\n  background: var(--clr-skeleton);\n  position: relative;\n  overflow: hidden;\n}\n.sk-line::after {\n  content: "";\n  position: absolute;\n  inset: 0;\n  background:\n    linear-gradient(\n      90deg,\n      transparent 0%,\n      var(--clr-skeleton-shine) 50%,\n      transparent 100%);\n  transform: translateX(-100%);\n  animation: shimmer 1.5s linear infinite;\n}\n.sk-short {\n  width: 30%;\n}\n.sk-long {\n  width: 75%;\n}\n.sk-medium {\n  width: 50%;\n}\n.sk-sm {\n  width: 22%;\n}\n@keyframes shimmer {\n  from {\n    transform: translateX(-100%);\n  }\n  to {\n    transform: translateX(100%);\n  }\n}\n.pagination {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-wrap: wrap;\n  gap: 0.4rem;\n  margin-top: 3rem;\n}\n.page-btn {\n  min-width: 2.75rem;\n  height: 2.75rem;\n  padding: 0 0.75rem;\n  border-radius: 0.75rem;\n  border: 1.5px solid var(--clr-border);\n  background: var(--clr-surface);\n  cursor: pointer;\n  font-weight: 600;\n  font-size: 0.9rem;\n  transition:\n    background 0.18s var(--ease-out-expo),\n    border-color 0.18s var(--ease-out-expo),\n    color 0.18s var(--ease-out-expo);\n  color: var(--clr-text);\n  touch-action: manipulation;\n}\n.page-btn:disabled {\n  opacity: 0.35;\n  cursor: not-allowed;\n}\n.page-btn.active {\n  background: var(--clr-text);\n  color: var(--clr-bg);\n  border-color: var(--clr-text);\n}\n.page-btn:hover:not(.active):not(:disabled) {\n  background: var(--clr-surface-hover);\n  border-color: var(--clr-border-strong);\n}\n.page-ellipsis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  min-width: 2rem;\n  height: 2.75rem;\n  font-size: 0.9rem;\n  color: var(--clr-text-faint);\n  -webkit-user-select: none;\n  user-select: none;\n}\n.page-counter {\n  display: none;\n}\n@media (max-width: 640px) {\n  .recipe-grid {\n    grid-template-columns: 1fr;\n  }\n  .btn-text {\n    display: none;\n  }\n  .search-btn {\n    padding: 0.85rem 1rem;\n  }\n  .pill {\n    min-height: 2.75rem;\n  }\n  .pill-sm {\n    min-height: 2.75rem;\n  }\n  .page-btn {\n    min-width: 2.75rem;\n    height: 2.75rem;\n  }\n}\n@media (max-width: 420px) {\n  .page-btn:not([aria-label]) {\n    display: none;\n  }\n  .page-ellipsis {\n    display: none;\n  }\n  .page-counter {\n    display: flex;\n    align-items: center;\n    font-size: 0.9rem;\n    font-weight: 600;\n    color: var(--clr-text);\n    padding: 0 0.75rem;\n  }\n}\n/*# sourceMappingURL=recipes.component.css.map */\n'] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RecipesComponent, { className: "RecipesComponent", filePath: "src/app/pages/recipes/recipes.component.ts", lineNumber: 487 });
})();
export {
  RecipesComponent
};
//# sourceMappingURL=chunk-YOYT4BPY.js.map
