    ...
    <div class="page">
      <div class="page-inner">
        ...
        <header class="page-header">
          ...
          <h1>Рецепти</h1>
          <p>Открий традиционни български рецепти за всеки повод — от лесни ежедневни ястия до класически празнични специалитети. Всяка рецепта е изпробвана и споделена с любов, с ясни стъпки и точни съставки. Филтрирай по категория, трудност или време за приготвяне и намери точното ястие за теб.</p>
        </header>
...
export class RecipesComponent {
  ...
  constructor() {
    this.seo.set({
      title: 'Рецепти',
      description: 'Традиционни български рецепти — от лесни ежедневни ястия до класически святи специалитети. Филтрирай по категория, трудност и време за приготвяне.',
    });
